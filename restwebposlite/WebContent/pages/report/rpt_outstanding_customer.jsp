				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-12 col-sm-12" align="center">
						<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
								code="admin.rpt_customer_list.jsp.cont_one"	text="Outstanding Customers Details" /></span>&nbsp;&nbsp; 
						...
						<a href="javascript:showpdfoutstandingcust(${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)"
							class="btn btn-success"
							style="background: #FF8576; margin-bottom: 3px;"><spring:message
								code="admin.rpt_customer_list.jsp.go" text="GO" /></a>
					</div>
					<div class="col-md-12 col-sm-12">
						<div id="outstandingCustomerListReportContainer"></div>
					</div>
				</div>
...
var pdf_url_outstanding_customer_list='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+ CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_OUTSTANDING_CUSTOMER)%>'; 
