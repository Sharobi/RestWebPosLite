...
<head>
    ...
    <title>:. POS :: FG STOCKIN ITEM WISE :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;">Fg StockIn ItemWise Report  </span>
				</div>
				<div class="col-md-12 col-sm-12">
   ...
   var pdf_url_fg_stockin_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_INVENTORY_FG_STOCKIN_ITEMWISE)%>';
