...
<head>
    ...
    <title>:. POS :: RAW STOCKOUT REGISTER :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;">Raw StockOut Register Report  </span>
				</div>
				<div class="col-md-9 col-sm-9">
                     <span style="color:#FFF; font-size:16px; font-weight:bold;">From Date:</span>
                     <input type="text" id="rptfromdate" size="10" style="width: 83px;" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     <span style="color:#FFF; font-size:16px; font-weight:bold;"> To Date: </spaln>
                     <input type="text" id="rpttodate" size="10" style="width: 83px;color:black;font-size:13px;" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     <input type="hidden" id="rpthiddate"  value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     <span style="color: #FFF; font-size: 16px; font-weight: bold;display:none;">Vendor:</span>&nbsp;&nbsp; 
                    <select id="vendor" class="form-control" style="width:auto;display:inline;height:28px;font-size: 12px;display:none;">
                      ...
                      <span style="color: #FFF; font-size: 16px; font-weight: bold;">Report Type:</span>&nbsp;&nbsp; 
						<select id="rptType" class="form-control" style="width:auto;display:inline;height:28px;font-size: 12px;">
							<option value="1">PDF</option>
							<option value="2">Excel</option>
						</select> 
                   <a href="javascript:showPdfRptInvRawStockoutRegister(document.getElementById('rptfromdate').value,document.getElementById('rpttodate').value,document.getElementById('vendor').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)" class="btn btn-success" style="background:#0C3;margin-bottom: 3px;">SUBMIT</a>
                </div>
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="rawInvStockOutRegisterRptContainerId" > 
                  </div> 
               </div>
           </div>
       </div>
   ...
   var pdf_url_inv_raw_stockout_register='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_INVENTORY_RAW_STOCKOUT_REGISTER)%>';
