...
<head>
    ...
    <title>:. POS :: RAW STOCKRETURN REGISTER :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;">Raw StockReturn Register Report  </span>
				</div>
   ...
   var pdf_url_raw_stockout_register='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_INVENTORY_RAW_STOCKRETURN_REGISTER)%>';
