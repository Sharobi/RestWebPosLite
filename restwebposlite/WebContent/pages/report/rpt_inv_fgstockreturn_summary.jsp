...
<head>
    ...
    <title>:. POS :: FG STOCKRETURN SUMARY :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;">FG StockReturn Summary Report  </span>
				</div>
   ...
   var pdf_url_fg_stockout_summary='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_INVENTORY_FG_STOCKRETURN_SUMMARY)%>';
