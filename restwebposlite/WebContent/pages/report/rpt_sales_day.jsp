...
<c:set var="today" value="<%=new java.util.Date()%>" />
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;">Select Date For Day wise Sales</span>&nbsp;&nbsp;
                    <span style="color:#FFF; font-size:16px; font-weight:bold;">From Date:</span>
                    <input type="text" id="daterptdaywiseSales" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     <span style="color:#FFF; font-size:16px; font-weight:bold;">To Date:</span>
                    <input type="text" id="todaterptdaywiseSales" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                    <input type="hidden" id="hiddaterptdaywiseSales" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                    <span style="color: #FFF; font-size: 16px; font-weight: bold;">Report Type:&nbsp;&nbsp; </span>
					<select id="rptType">
								<option value="1">PDF</option>
								<option value="2">Excel</option>
					</select>
                    <a href="javascript:showpdfrptdaywiseSales(document.getElementById('daterptdaywiseSales').value,document.getElementById('todaterptdaywiseSales').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)" class="btn btn-success" style="background:#FF8576;margin-bottom: 3px;">SUBMIT</a> 
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="daywisesalereportContainerId">
   ...
   $(document).ready(function() {
		...
		$('#todaterptdaywiseSales').datepicker({
			format : "yyyy-mm-dd",
			autoclose : true
		});
