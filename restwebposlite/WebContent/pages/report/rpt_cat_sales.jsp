        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;">Select Date For Category wise sales report : </span>&nbsp;&nbsp;
                   ...
                   <a href="javascript:showpdfrptcatwiseSales(document.getElementById('daterptcatwiseSales').value,document.getElementById('rptcatwiseSales'),${sessionScope.loggedinUser.storeId})" class="btn btn-success" style="background:#0CF;;margin-bottom: 3px;">SUBMIT</a> 
                </div>
