...
<head>
    ...
    <title>:. POS :: FG STOCKIN REGISTER :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;">Fg StockIn Register Report  </span>
				</div>
   ...
   var pdf_url_fg_stockin_register='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_INVENTORY_FG_STOCKIN_REGISTER)%>';
