        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;">Select Date For User wise Daily Sales</span>&nbsp;&nbsp;
                    ...
                    <span style="color:#FFF; font-size:16px; font-weight:bold;">USER:</span>&nbsp;&nbsp; 
