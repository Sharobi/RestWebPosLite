...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Periodic FG Vendor Payment Report :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_period_wise_vendor_payment.jsp.header" text="Fg Vendor Payment Report" /></span>
				</div>
				<div class="col-md-9 col-sm-9">
                    ...
                    <input type="text" id="todaterptvendorpayment" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     ...
                     <a href="javascript:showpdfrptperiodicFgVendorPayment(document.getElementById('fromdaterptvendorpayment').value,document.getElementById('todaterptvendorpayment').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value,document.getElementById('selectedvendorId').value)" class="btn btn-success" style="background:#41A1E3;margin-bottom: 3px;"><spring:message code="admin.rpt_item_wise_order_period.jsp.submit" text="SUBMIT" /></a> 
                    
                     
                </div> 
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="periodic_fgvendor_payment_report_ContainerId" >
   ...
   var pdf_url_periodic_fgvendor_payment='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_FG_VENDOR_PAYMENT_REPORT)%>';
