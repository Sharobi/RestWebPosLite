...
<body style="background-color: #e9e9e9;">
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10" style="background-color: #999;">
					...
					<div class="col-md-12 col-sm-12" style="background-color: #999;">
						<div class="col-md-2 col-sm-2">
							<div class="inv-requisition-0" style="font-size: 18px;"><spring:message code="base.inventory.jsp.fgreturn" text="FG RETURN" /></div>
                        ...
                        <div class="col-md-9 col-sm-9">
							<div class="inv-requisition-0">
								...
								<input type="text" disabled="disabled" id="" size="8" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
								 <spring:message code="base.inventory.jsp.fgreturnid" text="RETURN ID" /> 
								 <input type="text" id="clickedfgreturnid" disabled="disabled" size="5" value="0">
								  <spring:message code="base.inventory.jsp.fgstockin" text="INVOICE NO." /> 
								  <input type="text" id="clickedfgreturninvno"  size="10" value="" disabled="disabled">
								  <spring:message code="base.inventory.jsp.fgstockin.invdate" text="INVOICE DATE" /> 
								  <input type="text" id="clickedfgreturninvdate"  size="10" value="" disabled="disabled">
								  <spring:message code="admin.showdailyexpenditure.jsp.edit.vendor" text="VENDOR" /> 
								  <select id="clickedfgreturnvendorid" name="vendorId" disabled="disabled">
					...
					<div class="col-md-12 col-sm-12" style="background: #CCCCCC;">
						<div class="col-md-3 col-sm-3">
							<div>
								<form modelAttribute="estimateDailyProd" action="${pageContext.request.contextPath }/itemreturn/getfgstockreturnbydate.htm" method="post">
							...
							<div>
							<%-- <input type="text" class="text-input hide"  id="itmName" placeholder="<spring:message code="rm.fgstockin.jsp.srchByItemNameAndAdd" text="Search And Select Item By Name....." />" value="" style="width: 100%; " /> --%>
							<input type="text" size="25" placeholder="FG STOCKIN NUMBER" id="fgStockInNo" name="FgStockInNo" onkeydown="numcheck(event);"> &nbsp;&nbsp; <a href="javascript:bringStockinDetails()" id="stockincallbtn" class="btn btn-success" style="background: #78B626">ADD</a>
									...
									<table id="recipeingredientlist" class="table table-bordered" cellspacing="0" width="100%">
										...
										<tbody style="background-color: success">
										    <c:if test="${!empty itemLists}">
											  ...
											  <input type="hidden" value="${itemList.id}" id="hidfgstockoutId">	
												</c:forEach>
											</c:if> 
										</tbody>
									</table>
						...
						<div class="col-md-9 col-sm-9">
							<div class="col-md-2 col-sm-2 hide">
								<div style="width: 90%; margin-top: 8%;">
									<select name="selectedmenucategoryName" id="selectedmenucategoryName" class="selectedmenucategory hide" onChange="getSubCategory(this.value)">
							...
							<div class="col-md-4 col-sm-4">
								<div style="width: 100%; margin-top: 4%;">
									      <b><spring:message code="purchasereturn.jsp.returnreason" text="Return Reason" /></b>
							 ...
							 <div class="col-md-5 col-sm-5" id="approvediv" >
								<div class="inv-requisition">
									...
									</select><spring:message code="rm.fgstockin.jsp.by" text="By" />&nbsp;&nbsp;<input type="text" id="appvId" size="4" readonly> <a href="javascript:approveCall()" class="btn btn-success" id="fgstockreturnapprovedbuttion" style="background: #78B626"><spring:message code="rm.fgstockin.jsp.approve" text="APPROVE" /></a>
								</div>
							</div>
						</div>
						<div class="col-md-9 col-sm-9">
						<input type="text" class="text-input"  id="itmName" placeholder="<spring:message code="rm.fgstockin.jsp.srchByItemNameAndAdd" text="Search And Select Item By Name....." />" value="" style="width: 30%; " />
						<b>Remarks:</b> <input type="text" size="67" id="returnRemarks" value="" style="margin-bottom: 19px;">
						</div>
						<div class="col-md-9 col-sm-9">
							<div style="height: 365px; overflow-y: auto; background-color: #fff;">
								<table class='table table-bordered header-fixed' id="itemReturnTbl" style='border: 1px solid #fff;'>
									<thead style="background-color: #999;">
										...
										<th style='text-align: center;'><spring:message code="base.inventory.jsp.fgreturnqty" text="RETURN QTY" /></th>
										<th style='text-align: center;display:none;'><spring:message code="rm.fgstockin.jsp.itemdisc" text="DISCOUNT" /></th>
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.total" text="TOTAL" /></th>
										<th style='text-align: center;'><spring:message code="base.inventory.jsp.fgreturnreason" text="REASON" /></th>
							...
							<div align="center" id="savefgstockin">
							    ...
							    <div class="col-md-11 col-sm-11">
							         <!-- Discount(%): --><input type="text" size="5" id="discountId" onkeyup="javascript:calculateDiscount()" value='<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="false" value="0.00"/>' style="text-align: right;display:none;" onkeydown="numcheck(event);">
							         <!-- Discount Amt: --><input type="text" readonly size="8" id="discountAmtId"  value='<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="false" value="0.00"/>' style="text-align: right;display:none;">
							         CGST:<input type="text" readonly size="8" id="totalVatTaxId"  value='<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="false" value="0.00"/>' style="text-align: right;">
						             SGST:<input type="text" readonly size="8" id="totalServiceTaxId"  value='<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="false" value="0.00"/>' style="text-align: right;">
		...
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<div style="text-align: center; font-size: 20px;">Please Save FG Return First</div>
				</div>
	...
	<div class="modal fade" data-backdrop="static" id="poapprovedmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<div style="text-align: center; font-size: 20px;"><%-- <spring:message code="rm.fgstockin.jsp.fgStkSucApprvd" text="FG stockin successfully approved." /> --%>FG Return Successfully Approved</div>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
	...
	<div class="modal fade" data-backdrop="static" id="fgsuccessdmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<div style="text-align: center; font-size: 20px;"><%-- <spring:message code="rm.fgstockin.jsp.fgStkSucSave" text="FG stockin successfully saved Or Updated." /> --%>FG Return Successfully Saved Or Updated.</div>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
	...
	<div class="modal fade" data-backdrop="static" id="fgerrormodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
					<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel"><%-- <spring:message code="rm.fgstockin.jsp.success" text="Success" /> --%>Alert</h4>
				</div>
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<div style="text-align: center; font-size: 20px;"><%-- <spring:message code="itemstockin.jsp.errorinsave" text="Error!!!FG stockin is not saved." /> --%>Error!!!FG Return Is Not Saved.</div>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
	...
	<div class="modal fade" data-backdrop="static" id="simplestockindeletemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
					<button type="button" style="font-weight: bold; width: 25%;" class="btn btn-danger" data-dismiss="modal"><spring:message code="stockinnew.jsp.Cancel" text="Cancel" /></button>
					<button type="button" onclick="javascript:itemStockReturnDelete()" style="font-weight: bold; width: 25%;" data-dismiss="modal" class="btn btn-success"><spring:message code="stockinnew.jsp.OK" text="OK" /></button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" data-backdrop="static" id="displayfgstockinitemsbyitemidmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="width:65%">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
					<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="fgstockinitemsmodalheading"></h4>
				</div>
				<div class="modal-body" id="fgstockinmodalbody"  style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<!-- <table class="table table-bordered header-fixed" id="fgstockinmodalbodytable" style="border: 1px solid #fff;"> -->
					<table class="table table-bordered header-fixed" id="fgstockinmodalbodytable" style="background: inherit; border-top: inherit; color: inherit;">
									<thead style="background-color: #999;" id="fgstockinmodalbodytableheader">			
										<th style="text-align: center;" class="text-nowrap">STOCKID</th>
										<th style="text-align: center;" class="text-nowrap">INVOICE NO</th>
										<th style="text-align: center;" class="text-nowrap">VENDOR NAME</th>
										<th style="text-align: center;" class="text-nowrap">STOCK DATE</th>			
										<th style="text-align: center;" class="text-nowrap">UNIT</th>
										<th style="text-align: center;" class="text-nowrap">RATE</th>
										<th style="text-align: center;" class="text-nowrap">STOCK IN QTY</th>
										<th style="text-align: center;" class="text-nowrap">PREV RET QTY</th>
										<th style="text-align: center;" class="text-nowrap">CURRENT STOCK</th>										
									    </thead>
									    <tbody  id="fgstockinmodalbodytablebody">															    
									    </tbody>
								    </table>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
	...
	<script src="${pageContext.request.contextPath}/assets/js/itemReturnScript.js"></script>
	...
	var returnTypes =[];
    returnTypes = ${reasonslist};
		$(document).ready(function() {
			 var hidfgstockoutId=$("#hidfgstockoutId").val();
			  if( hidfgstockoutId != undefined){
				  rowClicked(hidfgstockoutId);
	 		  }else {
	 			 var activebutton ="<a href='javascript:itemStockReturnSave()' id='stockReturnSave' class='btn btn-success' style='background: #78B626; margin-top: 3px;'>Save</a>";
			...
			$('#clickedfgreturninvdate').datepicker({
 				format : "yyyy-mm-dd",
  			   //startDate: '-0d',
 				endDate: '+0d',
 				autoclose : true
		    ...
		    source : function(request, response) {
		          $.ajax({
		                      ...
		                      success : function(data) {
		                    	  //console.log("DATA IN AUTOCOMPLETE ITEM NAME IS:");
		                    	  //console.log(data);
		                          response($
		                                  .map( data,function(v) {
		                                       	     return {
		      ...
		      select : function(e, ui) {
		    	   ...
		    	   getFgStockInItemsByItemIdDesign(ui);
		       },
		      close: function(el) {
		          el.target.value = '';
		      }
