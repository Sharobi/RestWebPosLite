         ...
         <div class="col-md-10 col-sm-10">
            ...
            <div class="col-md-12 col-sm-12">
               <div id="daytimewiseunpaidorderContainerId">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y:auto;height:500px;">
                                    ...
                                    <h4 class="panel-title" style="width: inherit;">
                                       <c:if test = "${unpaidOrders.customerName == ''}">
                                          <a style="display:block; width:100%;"
                                             ...
                                             href="#collapse--${unpaidOrders.id}">
                                          Order No : ${unpaidOrders.orderNo}&nbsp;&nbsp;&nbsp;
                                          Order Type : ${unpaidOrders.ordertype.orderTypeName}
                                          </a>
                                       </c:if>
                                                ...
                                                <div class="table-responsive" id="unpaidordertableContId">
                                                                  ...
                                                                  <c:forEach items="${unpaidOrder.orderitem}" var="orderitems" varStatus="stat">
                                                                     <tr>
                                                                        ...
                                                                        <td style="text-align: center;" id="tdtotal${orderitems.id}">
                                                                           <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${orderitems.totalPriceByItem}"></fmt:formatNumber>
                                                                        </td>
                                                                        <%-- <td style="text-align: center;" id="tddisc${orderitems.id}">
                                                                           ...
                                                                           <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2"
                                                                               value="${(orderitems.rate*orderitems.item.promotionValue/100)*orderitems.quantityOfItem}"></fmt:formatNumber>
                                                                           </c:if>
                                                   ...
                                                   <c:if test="${! empty allunpaidOrderList}">
                                                      <c:forEach items="${allunpaidOrderList}" var="unpaidOrder">
                                                         <c:set var="iteratingOrderID" value="${unpaidOrder.id}" />
                                                         <c:if test="${presentOrderID == iteratingOrderID}">
                                                            <c:set var="subTotalAfterDiscount">
                                                               <fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.subTotalAmt - unpaidOrders.orderBill.customerDiscount}" />
                                                            </c:set>
                                                            <c:set var="custDisc">
                                                               <fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.customerDiscount}" />
                                                            </c:set>
                                                            <c:set var="totPrice">
                                                               <fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.billAmount}" />
                                                            </c:set>
                                                            <c:set var="netPrice">
                                                               <fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.billAmount}" />
                                                            ...
                                                            <c:set var="netTotal">
                                                               <fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.grossAmt}" />
                                                            </c:set>
                                                            ...
                                                            <input type="hidden" id="unpaidordersubtotal_${unpaidOrders.id}"  value="${subTotalAfterDiscount}">
                                                            <%-- <input type="hidden" id="unpaidorderscharge_${unpaidOrders.id}"   value="${unpaidOrders.orderBill.serviceChargeAmt}"> --%>
                                                            <input type="hidden" id="unpaidordervattax_${unpaidOrders.id}"    value="${unpaidOrders.orderBill.vatAmt}">
                                                            <input type="hidden" id="unpaidorderstax_${unpaidOrders.id}"      value="${unpaidOrders.orderBill.serviceTaxAmt}">
                                                            <input type="hidden" id="unpaidorderstrbaseorderno_${unpaidOrders.id}"      value="${unpaidOrders.orderNo}">
                                                         </c:if>
                                                      </c:forEach>
                                                   </c:if>
                                                   <input type="hidden" id="hidstoreroundoffFlag" value="${sessionScope.loggedinStore.roundOffTotalAmtStatus}">
                                                   <input type="hidden" id="hidstoredoubleroundoffFlag" value="${sessionScope.loggedinStore.doubleRoundOff}">
                                                   <input type="hidden" id="hidserviceTaxTextVal" value="${sessionScope.loggedinStore.serviceTaxText}">
                                                   <input type="hidden" id="hidvatTaxTextVal" value="${sessionScope.loggedinStore.vatTaxText}">
                                                   <input type="hidden" id="hidserviceTaxVal" value="${sessionScope.loggedinStore.serviceTaxAmt}">
                                                   <input type="hidden" id="hidvatTaxVal" value="${sessionScope.loggedinStore.vatAmt}">
                                                   <input type="hidden" id="hidpaidAmtVal" value="${paidAmount}"> 
                                                   <input type="hidden" id="hidcustDiscVal" value="${custDisc}"> 
                                                   <input type="hidden" id="hidnetTotal" value="${netTotal}">
                                                   <input type="hidden" id="hidparcelST" value="${sessionScope.loggedinStore.parcelServiceTax}">
                                                   <input type="hidden" id="hidparcelVat" value="${sessionScope.loggedinStore.parcelVat}">
                                                   <input type="hidden" id="mobPrintVal" value="${sessionScope.loggedinStore.mobBillPrint}">
                                                   <input type="hidden" id="kotPrintVal" value="${sessionScope.loggedinStore.kitchenPrintBt}">
                                                   <input type="hidden" id="printbillpapersize" value="${sessionScope.loggedinStore.printBillPaperSize}">
                                                   <div class="col-md-6 col-sm-6">
                                                      ...
                                                      <c:if test="${sessionScope.loggedinStore.id==120}">
                                                         <a href="javascript:printBillWithReason()" class="btn-order-taking" style="text-align: center;">&nbsp;PRINT </a>
                                                      </c:if>
                                                   </div>
                                                   <div class="col-md-6 col-sm-6">
                                                      <div class="order-summery"
                                                         ...
                                                         <c:if
                                                            ...
                                                            <div id="discPerContId" class="col-md-6 col-sm-3">
                                                               Discount (${unpaidOrders.orderBill.discountPercentage}%):
                                                            </div>
                                                         ...
                                                         <div id="subtotalcontId"
                                                            ...
                                                            <fmt:formatNumber type="number"
                                                               groupingUsed="false" minFractionDigits="2"
                                                               maxFractionDigits="2" value="${subTotalAfterDiscount}" />
                                                         </div>
                                                         <br />
                                                        <div class="col-md-6 col-sm-6">
                                                         ...
                                                         <div id="vatcontId"
                                                            ...
                                                            <fmt:formatNumber type="number"
                                                               groupingUsed="false" minFractionDigits="2"
                                                               maxFractionDigits="2" value="${unpaidOrders.orderBill.vatAmt}" />
                                                         </div>
                                                         <br />
                                                         <c:if
                                                            ...
                                                            <div id="servicetaxcontId"
                                                               ...
                                                               <fmt:formatNumber type="number"
                                                                  groupingUsed="false" minFractionDigits="2"
                                                                  maxFractionDigits="2" value="${unpaidOrders.orderBill.serviceTaxAmt}" />
                                                            </div>
                                                            <br />
                                                         </c:if>
                                                         ...
                                                         <div id="grandtotalcontId" class="grandtotalcontId_${presentOrderID}"
                                                            ...
                                                            <fmt:formatNumber type="number"
                                                               groupingUsed="false" minFractionDigits="2"
                                                               maxFractionDigits="2"
                                                               value="${unpaidOrders.orderBill.grossAmt}" />
                                                         </div>
                                                         <br />
                                                         <div class="col-md-6 col-sm-6">
            ...
            <div class="modal-dialog" style="margin: 100px auto;">
               <div class="modal-content"
                  ...
                  <div class="modal-body"
                     style="background: #404040; border-top: 1px solid #404040; color: #fff;">
                     <div style="text-align: center; font-size: 20px;" >
                        <spring:message code="order.jsp.noonlinepaymentmode" text="No online payment mode available." />
                     </div>
                  </div>
                  <div class="modal-footer"
                     style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
               ...
               <div class="modal-body" id="printDiv2100GST"
                  ...
                  <div>
                     <table style="height: 50px; width: 100%;">
                        ...
                        <tr id="paymentmode_paidbill_2100px_trid">
                           ...
                           <td width="50%" style="float: right; padding-right: 40px; text-align: center; font-size: 14px; font-family: sans-serif;">
                              <b><span id="paymentmode_paidbill_2100px"></span></b>
                           </td>
                        </tr>
                     </table>
                  </div>
               ...
               <div class="modal-body" id="printDiv80"
                  ...
                  <div
                     ...
                     <font
                        style="font-size: 12px; font-style: inherit; font-family: sans-serif;">
                        <div
                           id="storeEmail80">Email:${sessionScope.loggedinStore.emailId}</div>
                     </font>
                     <font
                        style="font-size: 10px; font-style: normal; font-family: sans-serif;">
                        <div
                           id="storePhNo80">Ph:${sessionScope.loggedinStore.mobileNo}</div>
                     </font>
                     <br>
                     <%-- <div
                     ...
                     <table style="height: 50px; width: 100%;">
                        ...
                        <tr id="cashshowDiscount80px">
                           <td
                              ...
                              TOTAL DISCOUNT (<span id="paidbilldiscpers80"></span>%):
                           </td>
                           <td style="font-size: 11px; font-weight: bold; font-family: sans-serif;">${sessionScope.loggedinStore.currency}
                           </td>
                           <td
            ...
            <div class="modal-dialog" style="width: 276px; height: auto;">
               <div class="modal-body" id="printDiv2100"
                  ...
                  <div
                     ...
                     <b>
                        <font
                           style="font-size: 19px; font-style: inherit; font-family: sans-serif;">
                           <div
                              id="storeName2100"></div>
                        </font>
                     </b>
                     <b>
                        <font
                           style="font-size: 17px; font-style: normal; font-family: sans-serif;">
                           <div
                              id="storeAddr2100"></div>
                        </font>
                     </b>
                     <font
                        style="font-size: 15px; width: auto; font-style: inherit; font-family: sans-serif;">
                        <div
                           id="storeEmail2100"></div>
                     </font>
                     <font
                        style="font-size: 15px; width: auto; font-style: normal; font-family: sans-serif;">
                        <div
                           id="storePhNo2100"></div>
                     </font>
                     <br>
                     <div
                        style="text-align: left; font-size: 15px; font-family: sans-serif;">
                     ...
                     <div class="table-responsive" id="orderitemContId_2100">
                        <table
                           ...
                           <thead>
                              <tr>
                                 <th style="font-size: 15px; width: 102px;">
                                 <span style="float: left; font-family: sans-serif;">Item </span></th>
                                 <th
                     ...
                     <table style="height: 50px; width: 100%;">
                        ...
                        <tr id="cashtotalServiceTax2100px">
                           <td
                              style="font-size: 15px; font-weight: bold; font-family: sans-serif;">Total
                              Service Tax(${sessionScope.loggedinStore.serviceTaxAmt}%):
                           </td>
                           <td
                              style="float: right; padding-right: 40px; text-align: center; font-size: 14px; font-family: sans-serif;"><span
                        ...
                        <tr id="cashtotalVatTax2100px">
                           <td
                              style="font-size: 15px; font-weight: bold; font-family: sans-serif;">Total
                              Vat(${sessionScope.loggedinStore.vatAmt}%):
                           </td>
                           <td
                              style="float: right; padding-right: 40px; text-align: center; font-size: 14px; font-family: sans-serif;"><span
