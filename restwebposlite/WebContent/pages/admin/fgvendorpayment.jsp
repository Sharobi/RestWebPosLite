...
<head>
    ...
    <title>:. POS :: FG Vendor Payment :.</title>
...
<body>
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
                <div class="col-md-5 col-sm-5">
                    <div style="color:#FFF; font-size:16px; font-weight:bold;">FG VENDOR PAYMENT</div> 
                </div>
                                    		...
                                    		<c:if test="${! empty invInvoiceList }">
                                    			...
                                    			<c:forEach items="${invInvoiceList}" var="creditinvinvoice">
                                    				<tr style="background:#404040; color:#FFF;">
                                    					<td align="center">${creditinvinvoice.fgStockInId}</td>
                                    					<td align="center">${creditinvinvoice.fgStockInDate}</td>
                                    					...
                                    					<td align="center"><a href="javascript:opencr_vendorCashModal(${creditinvinvoice.fgStockInId},&quot;${creditinvinvoice.fgStockInDate}&quot;,${creditinvinvoice.billAmount},${creditinvinvoice.paidAmount},${creditinvinvoice.amountToPay})" class="btn btn-success">PAY</a></td>
                                    				</tr>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/fgvendorpaymet.js"></script>
