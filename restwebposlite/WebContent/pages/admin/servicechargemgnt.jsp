...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Service Charge Setup :.</title>
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
                <div class="col-md-12 col-sm-12">
                    <div style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.taxmgnt.jsp.updateServChargeForAllOrderTypes" text="UPDATE SERVICE CHARGE FOR ALL ORDER TYPES" /></div> 
                </div>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <div class="col-md-4 col-sm-4">
                  	<table style="color: #fff;font-size: 16px;">
                  		<c:if test="${! empty sessionScope.loggedinStore.serviceChargeFlag && sessionScope.loggedinStore.serviceChargeFlag=='Y'}">
                  		<c:forEach items="${orderTypeList}" var="orderTypeList" varStatus="stat">
                            	<tr>
                            		<td>
                            			<input type="checkbox" id="${orderTypeList.ordertypeShortName}" name="serviceChargeChk" onclick="enableserviceChargeTxt(this,${orderTypeList.id})" value="${orderTypeList.orderTypeName}" style="margin-bottom: 5px;">&nbsp;&nbsp;&nbsp;
                            		</td>
                            		<td>
                            			${orderTypeList.orderTypeName}&nbsp;&nbsp;&nbsp;
                            			<input type="hidden" id="${orderTypeList.orderTypeName}" value="${orderTypeList.ordertypeShortName}">
                            		</td>
                            		<td>
                            			<input type="text" id="ordtype_${orderTypeList.id}" size="4" disabled="disabled" value="${orderTypeList.serviceChargeValue}" style="margin-bottom: 5px;color: #222222;">&nbsp;%
                            		</td>
                            	</tr>
                            	</c:forEach>
                         </c:if>
                         ...
                         <tr>
                         	<td></td>
                         	<td></td>
                         	<td><a href="javascript:updateserviceCharge()" class="btn btn-success" style="background:#41A1E3;margin-top: 5px;"><spring:message code="admin.taxmgnt.jsp.submit" text="SUBMIT" /></a> </td>
                         </tr>
