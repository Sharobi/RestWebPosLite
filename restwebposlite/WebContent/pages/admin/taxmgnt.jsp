        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
                <div class="col-md-12 col-sm-12">
                    <div style="color:#FFF; font-size:16px; font-weight:bold;">UPDATE TAX FOR ALL ITEMS</div> 
                </div>
                  ...
                  <div class="col-md-4 col-sm-4">
                  	<table style="color: #fff;font-size: 16px;">
                         ...
                         <tr>
                         	<td></td>
                         	<td></td>
                         	<td><a href="javascript:updatetaxAllItem()" class="btn btn-success" style="background:#41A1E3;margin-top: 5px;">SUBMIT</a> </td>
                         </tr>
